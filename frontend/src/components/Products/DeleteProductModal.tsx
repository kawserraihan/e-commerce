...
import { useDeleteProductMutation } from '../../../redux/features/authApiSlice'; // Adjust the import as per your file structure
...
interface DeleteProductModalProps {
  isOpen: boolean;
  onClose: () => void;
  product: { id: number; product_name: string }; // Data of the product to delete
}
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-md shadow-md w-full max-w-md">
        ...
        <p className="mb-6">
          Are you sure you want to delete the Product <strong>{product.product_name}</strong>? This action cannot be undone.
        </p>
