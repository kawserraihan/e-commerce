...
interface ProductImageComponentProps {
    additionalPreviews: string[]; // Array of image URLs or preview strings
    previewImage: string | null; // Preview image can be a string URL or null
    handleImageChange: (e: React.ChangeEvent<HTMLInputElement>) => void; // Function for handling file input change
    handleAdditionalImagesChange: (e: React.ChangeEvent<HTMLInputElement>) => void; // Function for handling multiple file input change
    handleRemoveImage: (index: number) => void; // Function for removing an image by index
  }
