...
import { useDeleteSizeMutation } from '../../../../redux/features/authApiSlice'; // Adjust the import as per your file structure
...
interface DeleteSizeModalProps {
  isOpen: boolean;
  onClose: () => void;
  size: { id: number; size_name: string }; // Data of the Size to delete
}

const DeleteSizeModal: React.FC<DeleteSizeModalProps> = ({ isOpen, onClose, size }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-md shadow-md w-full max-w-md">
        <h2 className="text-lg font-semibold mb-4">Delete Size</h2>
        <p className="mb-6">
          Are you sure you want to delete the size <strong>{size.size_name}</strong>? This action cannot be undone.
        </p>
