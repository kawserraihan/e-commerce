        ...
        <table className="w-full table-auto">
          <thead>
            <tr className="bg-gray-2 text-center dark:bg-meta-4">
              ...
              <th className="min-w-[100px] px-5 py-4 text-sm text-center text-black dark:text-white xl:pl-1">
                Size
              </th>
          ...
          <tbody>
            {sizeData.map((sizeItem, key) => (
              <tr key={key}>
                ...
                <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark text-center">
                  <p className="text-black dark:text-white">
                    {sizeItem.subcategory}
                  </p>
                </td>
                <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark text-center">
                  <p className="text-black dark:text-white">
                    {sizeItem.childcategory}
                  </p>
                </td>
                <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark text-center">
                  <p className="inline-flex rounded-full bg-opacity-10 py-1 px-2 font-bold text-sm bg-warning text-warning">
                    {sizeItem.size}
                  </p>
                </td>
