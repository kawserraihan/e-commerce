...
const childData: Childcategory[] = [
  ...
  },
  {
    ...
    category: "Men Wear",
    subcategory: "Traditional Wear",
    childcategory: "Panjabi",
  },
];

const ChildCategory = () => {
  const currentPage = 2; // This could come from query params or state
  const totalPages = 10;
