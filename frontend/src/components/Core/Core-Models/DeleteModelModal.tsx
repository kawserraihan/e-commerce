...
import { useDeleteModelMutation } from '../../../../redux/features/authApiSlice'; // Adjust the import as per your file structure
...
interface DeleteModelModalProps {
  isOpen: boolean;
  onClose: () => void;
  model: { id: number; model_name: string }; // Data of the model to delete
}

const DeleteModelModal: React.FC<DeleteModelModalProps> = ({ isOpen, onClose, model }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-md shadow-md w-full max-w-md">
        ...
        <p className="mb-6">
          Are you sure you want to delete the model <strong>{model.model_name}</strong>? This action cannot be undone.
        </p>
