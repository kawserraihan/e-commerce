          ...
          <tbody>
            {colorData.map((colorItem, key) => (
              <tr key={key}>
                ...
                <td className="border-b border-[#eee] px-5 py-5 dark:border-strokedark text-center xl:pl-2">
                <p className="text-sm">
                    {colorItem.colorName}
                    <span
                    className="ml-2 inline-block w-4 h-4 rounded-full relative align-middle" 
                    style={{
                        backgroundColor: colorItem.colorName,
                        boxShadow:
