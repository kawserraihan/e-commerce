...
import { useDeleteColorMutation } from '../../../../redux/features/authApiSlice'; // Adjust the import as per your file structure
...
interface DeleteColorModalProps {
  isOpen: boolean;
  onClose: () => void;
  color: { id: number; color_name: string }; // Data of the color to delete
}

const DeleteColorModal: React.FC<DeleteColorModalProps> = ({ isOpen, onClose, color }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-md shadow-md w-full max-w-md">
        <h2 className="text-lg font-semibold mb-4">Delete Color</h2>
        <p className="mb-6">
          Are you sure you want to delete the color <strong>{color.color_name}</strong>? This action cannot be undone.
        </p>
