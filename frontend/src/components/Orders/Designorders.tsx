...
const orderData: Order[] = [
  ...
  },
  {
    no: 4,
    orderNo: 4,
    customer: "Sheikh Rayhan",
    customerContact: "01826629022",
    totalAmount: 6500,
          ...
          <tbody>
            {orderData.map((orderItem, key) => (
              <tr key={key}>
                ...
                <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark font-bold">
                  <p
                ...
                <td className="border-b border-[#eee] px-4 py-5 pl-9 dark:border-strokedark xl:pl-5">
                  <h5 className="inline-flex rounded-full bg-opacity-10 px-6 py-1 text-sm bg-success text-success font-bold">
                    {orderItem.paymentStatus}
                  </h5>
                  <p className="font-bold" style={{ fontSize: '12px' }}>Paid: {orderItem.paidAmount} ৳</p>
                </td>
                <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
