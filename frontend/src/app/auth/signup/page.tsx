...
const {first_name,last_name,email,password,re_password} = formData;
    ...
    const onSubmit = async (event: FormEvent<HTMLFormElement>) =>{
      ...
      console.log('Form data:', { first_name, last_name, email, password, re_password });
      ...
      try {
        ...
        // If the error is coming from the API response, handle it here
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={onSubmit}>
                <div className="mb-4">
                  <label htmlFor="first_name" className="mb-2.5 block font-medium text-black dark:text-white">
                    First Name
                  </label>
...
<span className="absolute right-4 top-4">
                ...
                <div className="mb-4">
                  <label htmlFor="last_name" className="mb-2.5 block font-medium text-black dark:text-white">
                    Last Name
                  </label>
                  <div className="relative">
                    <input
...
<span className="absolute right-4 top-4">
                ...
                <div className="mb-6">
                  <label htmlFor="re_password" className="mb-2.5 block font-medium text-black dark:text-white">
                    Re-type Password
                  </label>
